...
import ARInput from "../ar/ARInput";

export const Header = () => {
    return (
        <header className="bg-[#FFFFFF] border-b-2 border-border shadow-md sticky top-0 z-50">
            <nav className=" border-gray-200 px-4 lg:px-7 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <Link to="/" className="flex items-center">
                        {/* <img
                            src={Logo}
                            className="h-4 sm:h-9 bg-transparent">
                        </img> */}
